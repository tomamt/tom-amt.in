...
@Component({
  selector: 'ngx-delivery-agent-breaks',
  templateUrl: './delivery-agent-breaks.component.html',
  styleUrls: ['./delivery-agent-breaks.component.scss']
})
export class DeliveryAgentBreaksComponent implements OnInit {
 ...
 removeByAttr (arr, attr, value){
  ...
  CnsumerIssuesList(){ 
    this.spinner.show();
    this.apiService.Issueslist('da-break', this.page).subscribe((res)=>{
      this.spinner.hide();
